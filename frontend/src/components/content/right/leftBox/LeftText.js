...
function LeftText(props) {
  ...
  const [textC, settextC] = useState("black");
  const [strokeC, setstrokeC] = useState("black");
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    Text: (text) => {
      dispatch(leftText(text));
    },
    TextColor: (color) => {
      dispatch(leftTextColor(color));
    },
    size: (size) => {
      dispatch(leftTextSize(size));
    },
    stroke: (stroke) => {
      dispatch(leftTextStroke(stroke));
    },
    strokeColor: (color) => {
      dispatch(leftTextStrokeColor(color));
    },
    family: (family) => {
      dispatch(leftTextFamily(family));
    },
  };
};
