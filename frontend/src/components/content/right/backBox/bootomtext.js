...
import {
  ...
  backBotTextSize,
  backBotTextStroke,
  backBotTextStrokeColor,
  backBotTextFamily,
} from "../../../../actions";

import { globalColors, globalFonts } from "../../../../assets";

function BackBotText(props) {
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    Text: (text) => {
      dispatch(backBotText(text));
    },
    TextColor: (color) => {
      dispatch(backBotTextColor(color));
    },
    size: (size) => {
      dispatch(backBotTextSize(size));
    },
    stroke: (stroke) => {
      dispatch(backBotTextStroke(stroke));
    },
    strokeColor: (color) => {
      dispatch(backBotTextStrokeColor(color));
    },
    family: (family) => {
      dispatch(backBotTextFamily(family));
    },
  };
};

export default connect(null, mapDispatchToProps)(BackBotText);
