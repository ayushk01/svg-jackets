...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    Text: (text) => {
      dispatch(backTopText(text));
    },
    TextColor: (color) => {
      dispatch(backTopTextColor(color));
    },
    size: (size) => {
      dispatch(backTopTextSize(size));
    },
    stroke: (stroke) => {
      dispatch(backTopTextStroke(stroke));
    },
    strokeColor: (color) => {
      dispatch(backTopTextStrokeColor(color));
    },
    family: (family) => {
      dispatch(backTopTextFamily(family));
    },
  };
};

export default connect(null, mapDispatchToProps)(BackTopText);
