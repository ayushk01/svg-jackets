...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    Text: (text) => {
      dispatch(frontRightText(text));
    },
    TextColor: (color) => {
      dispatch(frontRightTextColor(color));
    },
    size: (size) => {
      dispatch(frontRightTextSize(size));
    },
    stroke: (stroke) => {
      dispatch(frontRightTextStroke(stroke));
    },
    strokeColor: (color) => {
      dispatch(frontRightTextStrokeColor(color));
    },
    family: (family) => {
      dispatch(frontRightTextFamily(family));
    },
  };
};
